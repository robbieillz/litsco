angular.module("app_litsco").controller("controller_supplies", [
  "$scope",
  "$state",
  "$stateParams",
  "factory_litsco",
  "factory_meta",
  function($scope, $state, $stateParams, factory_litsco, factory_meta) {
    ...
    factory_meta.supply(
      "LITSCO supplies " +
        productListNameArray.join(", ") +
        ", with options for boom truck deliveries to your site.",
      "LITSCO, " +
        productListNameArray.join(", ") +
        ", Roofing Supplies, Waterproofing Supplies, Commercial Metal Panels, Building Envelope, Division 7 Specialties, Division 7 Building Products"
    );
    ...
    function getCategoryInteger(cat) {
      if (cat === "roofing") {
        ...
        $scope.productHeader = "Commercial Metal Panels";
        return 5;
